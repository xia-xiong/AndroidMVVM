...
fun Context.getBooleanBySp(key: String, name: String = PerfConstant.SP_NAME, defaultValue: Boolean = false): Boolean {
    return getSharedPreferences(name, Context.MODE_PRIVATE)?.getBoolean(key, defaultValue)
            ?: defaultValue
}

fun Context.getIntBySp(key: String, name: String = PerfConstant.SP_NAME, defaultValue: Int = 0): Int {
    return getSharedPreferences(name, Context.MODE_PRIVATE)?.getInt(key, defaultValue)
            ?: defaultValue
}

fun Context.getLongBySp(key: String, name: String = PerfConstant.SP_NAME, defaultValue: Long = 0): Long {
    return getSharedPreferences(name, Context.MODE_PRIVATE)?.getLong(key, defaultValue)
            ?: defaultValue
}

fun Context.getStringBySp(key: String, name: String = PerfConstant.SP_NAME, defaultValue: String = ""): String? {
    return getSharedPreferences(name, Context.MODE_PRIVATE)?.getString(key, defaultValue)
            ?: defaultValue
}

fun Fragment.getBooleanBySp(key: String, name: String = PerfConstant.SP_NAME, defaultValue: Boolean = false): Boolean {
    return activity?.getSharedPreferences(name, Context.MODE_PRIVATE)?.getBoolean(key, defaultValue)
            ?: defaultValue
}

fun Fragment.getIntBySp(key: String, name: String = PerfConstant.SP_NAME, defaultValue: Int = 0): Int {
    return activity?.getSharedPreferences(name, Context.MODE_PRIVATE)?.getInt(key, defaultValue)
            ?: defaultValue
}

fun Fragment.getLongBySp(key: String, name: String = PerfConstant.SP_NAME, defaultValue: Long = 0): Long {
    return activity?.getSharedPreferences(name, Context.MODE_PRIVATE)?.getLong(key, defaultValue)
            ?: defaultValue
}

fun Fragment.getStringBySp(key: String, name: String = PerfConstant.SP_NAME, defaultValue: String = ""): String {
